...
export default function Details() {
  ...
  return (
    <div>
      <Head>
        <title>Comments | Community</title>
      ...
      <div className="my-4">
        <div className="flex">
          ...
          <button
            ...
            className="bg-cyan-500 hover:bg-cyan-600 text-white py-3 px-3 text-2xl rounded-full z-10 rotate-90"
          >
            <HiPaperAirplane />
          </button>
        </div>
        <div className="py-6">
          ...
          {allMessages?.map((message) => (
            <div
              className="bg-gray-400 p-4 my-4 bg-opacity-50 rounded-lg"
              key={message.time}
            >
